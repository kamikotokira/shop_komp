<div class="header">
    <h2>Редактировать заявку #<?= htmlspecialchars($request['RequestID']) ?></h2>
    <div>
...
<form method="POST" class="form">
    <div class="form-group">
        ...
        <select name="SupplierID" id="SupplierID" required>
            <?php foreach ($suppliers as $supplier): ?>
                <option value="<?= $supplier['SupplierID'] ?>" <?= $supplier['SupplierID'] == $request['SupplierID'] ? 'selected' : '' ?>>
    ...
    <div class="form-group">
        ...
        <input type="date" name="Date" id="Date" value="<?= htmlspecialchars($request['Date']) ?>" required>
    </div>
